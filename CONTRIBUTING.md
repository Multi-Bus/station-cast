...
- `main` 브랜치에 직접 push 하지 않습니다. 모든 변경은 Issue → 브랜치 → PR → merge 순서를
  따릅니다. 리뷰 승인은 GitHub에서 더 이상 강제하지 않지만, 가능하면 머지 전에 받습니다.
...
4. 가능하면 리뷰를 받고, 급하면 바로 merge해도 됩니다 — 승인은 강제되지 않습니다.
